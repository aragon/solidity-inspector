...
class ContractStructure {
    ...
    toJSON(mergeWithParents) {
        ...
        for (let part of ['functions', 'events', 'contstantFunctions'])
    ...
    getPragma() {
        this.getCached('pragma', () => {
            ...
            return pragmaStatement && pragmaStatement.start_version ? pragmaStatement.start_version.operator + pragmaStatement.start_version.version : '';
        });
    }
